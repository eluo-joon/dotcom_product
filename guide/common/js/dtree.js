...
function dTree(objName, data) {
    ...
    this.icon = {
        root				: './common/images/base.gif',
        folder			: './common/images/folder.gif',
        folderOpen	: './common/images/folderopen.gif',
        node			: './common/images/page.gif',
        empty			: './common/images/empty.gif',
        line				: './common/images/line.gif',
        join				: './common/images/join.gif',
        joinBottom	: './common/images/joinbottom.gif',
        plus				: './common/images/plus.gif',
        plusBottom	: './common/images/plusbottom.gif',
        minus			: './common/images/minus.gif',
        minusBottom: './common/images/minusbottom.gif',
        nlPlus			: './common/images/nolines_plus.gif',
        nlMinus			: './common/images/nolines_minus.gif'
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (node.url && !pop) {
        str += ' <a href="' + node.url + '" target="_blank"><img src="./common/images/icon_popup.gif"></a>';
    }
